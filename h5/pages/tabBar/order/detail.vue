<template>
	...
	<view class="order-container">
		...
		<view class="materialList">
			<view class="materialItem" v-for="(item,index) in orderDetailData.sub_order_materials">
				...
				<view class="detail">
					...
					<view class="unit">{{item.o_m_package}}</view>
					<view class="price">
						<text class="total">
		...
		<view class="account">
			<o-button :order="orderDetailData" @refresh="getOrderDetail" />
		</view>
	</view>
</template>
